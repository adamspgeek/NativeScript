...
export class Page extends pageCommon.Page {
    ...
    public onLayout(left: number, top: number, right: number, bottom: number) {
        ...
        console.log("navigationBar " + this.frame.ios.controller.navigationBar + " " + this.frame.ios.controller.navigationBar.translucent);
        if (this.frame.ios.controller.navigationBar &&
